...
// 1500년대에 태어난 발명가
const inventors1500 = inventors.filter((obj) => obj.year >= 1500 && obj.year < 1600);
...
// 생애기간의 총합?
const allTogether = inventors.reduce((total, a) => total + (a.passed - a.year), 0);
...
// const category = document.querySelector('.name-list');
